...
public class UserController {
	...
	@GetMapping("/{username}/seeComplaint")
	...
	@GetMapping("/giftByCategory/{category}")
	...
	//Add a complaint
	@PostMapping("/{username}/addComplaint/{orderID}")
